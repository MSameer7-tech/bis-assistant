...
export class LabFinderComponent {
     ...
     */
    getInitialGuideHtml() {
        const title = this.t('lab_finder.empty_state_title', 'Find a laboratory');
        ...
        return `
            <div class="results-empty-state" id="initialGuideState">
                <div class="empty-state-emblem" aria-hidden="true">
                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6"/><path d="M10 3v5.5L4.7 18a2 2 0 0 0 1.7 3h11.2a2 2 0 0 0 1.7-3L14 8.5V3"/><path d="M8 15h8"/><path d="M7 18h10"/></svg>
                </div>
                ...
                <div class="empty-state-shortcuts">
                    ...
                    <button type="button" class="shortcut-pill" data-query="find labs for drinking water in Gujarat" data-standard="IS 10500">Drinking water testing</button>
                    <button type="button" class="shortcut-pill" data-query="find me cement testing lab" data-standard="IS 269">Portland cement</button>
                    <button type="button" class="shortcut-pill" data-query="find recognized labs for water heaters near Delhi" data-standard="IS 8978">Water heater labs</button>
                    <button type="button" class="shortcut-pill" data-query="find labs for testing helmets" data-standard="IS 4151">Protective helmets</button>
                </div>
            </div>
        `;
    }
